...
report 50026 "ecSales Return Order"
{
    ApplicationArea = All;
    ...
    RDLCLayout = '.\src\EuroCompany\BaseApp\Sales\Reports\SalesReturnOrder.Layout.rdlc';
    UsageCategory = None;
    dataset
    {
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(SalesLine_ShipmentDate; Format(Temp_SalesLine_Print."Shipment Date", 0, '<Day,2>/<Month,2>/<Year4>'))
                        {
                        }
                        ...
                        begin
                            ...
                            then begin
                                if not awpCommentsManagement.IsValidCommentReasonByReport(Temp_SalesLine."AltAWPComment Reason Code",
                                                                                          Report::"AltAWPSales Return Order")
                                then begin
                                    CurrReport.Skip();
                                end;
                            end;
            ...
            begin
                ...
                HeaderCommentText := PrintFunctions.GetDocumentCommentHeader(SalesHeader, Report::"ecSales Return Order");
